...
import com.bestbuy.pojo.ServicesPojo;
...
public class ServicesSteps {
    ...
    @Step("Getting the information of the services created by id:{0}")
    public ValidatableResponse getServiceById(long servicesId) {
